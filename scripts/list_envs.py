...
All the environments are registered in the `bot_balance` extension. They start
...
import bot_balance.tasks  # noqa: F401


def main():
    """Print all environments registered in `bot_balance` extension."""
